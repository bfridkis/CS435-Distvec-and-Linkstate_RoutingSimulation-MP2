...
void converge(int sourceNode, std::vector<std::map<int, int>> &_TT, std::vector<std::map<int, std::pair<std::vector<int>, int>>> &_FT, std::vector<std::pair<int,int>> &tiesTracker) {	
